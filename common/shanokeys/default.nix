      ...
      numpad = {
        ...
        mappings = {
          kp1 = {
            ...
            params = {
              sceneName = "Intermezzo";
            };
          };
          kp2 = {
            endpoint = "SetCurrentPreviewScene";
            params = {
              sceneName = "Fullscreen closeup";
            };
          };
          kp3 = {
            endpoint = "SetCurrentPreviewScene";
            params = {
              sceneName = "Fullscreen audience";
            };
          };
          kp4 = {
            endpoint = "SetCurrentPreviewScene";
            params = {
              sceneName = "Fullscreen overview";
            };
          };
          kp5 = {
            endpoint = "SetCurrentPreviewScene";
            params = {
              sceneName = "Fullscreen slides";
            };
          };
          kp6 = {
            endpoint = "SetCurrentPreviewScene";
          ...
          kpenter = {
            endpoint = "TriggerStudioModeTransition";
          };
        };
      };
    };
    ...
    keyboards =
      (lib.mapAttrs (
        keyboard: props: {
          ...
          settings = {
            main = (
              lib.mapAttrs (key: cmd: "command(${shanokeys}/bin/shanokeys ${keyboard} ${key})") props.mappings
            );
          };
        }
      ))
